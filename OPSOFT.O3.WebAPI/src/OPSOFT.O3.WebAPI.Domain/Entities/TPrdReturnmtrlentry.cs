...
/// 生产退料单明细
/// </summary>
[SugarTable("T_PRD_RETURNMTRLENTRY")]
public class TPrdReturnmtrlentry : BaseEntity
{
    /// <summary>
    /// 实发数量
    /// </summary>
    ...
    /// 生产用料清单编码
    /// </summary>
    [SugarColumn(ColumnName = "FPPBOMBILLNO", IsNullable = true)]
    ...
    /// 生产用料清单表体内码
    /// </summary>
    [SugarColumn(ColumnName = "FPPBOMENTRYID", IsNullable = true)]
    ...
    /// 生产用料清单内码
    /// </summary>
    [SugarColumn(ColumnName = "FPPBOMID", IsNullable = true)]
