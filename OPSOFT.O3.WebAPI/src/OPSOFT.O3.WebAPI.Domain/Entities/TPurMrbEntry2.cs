...
/// 采购退料-箱码-最底阶
/// </summary>
[SugarTable("T_PUR_MRBENTRY2")]
public class TPurMrbEntry2 : BaseEntity
{
    /// <summary>
    /// 退料通知单
    /// </summary>
    [SugarColumn(ColumnName = "FMRBAPPNO")]
    public string Fmrbappno { get; set; } = string.Empty;

    /// <summary>
    /// 退料通知单内码
    /// </summary>
    [SugarColumn(ColumnName = "FMRBAPPID")]
    public string Fmrbappid { get; set; } = string.Empty;

    /// <summary>
    /// 退料通知表体内码
    /// </summary>
    [SugarColumn(ColumnName = "FMRBAPPDETAILID")]
    public string Fmrbappdetailid { get; set; } = string.Empty;
