...
/// 会议管理-表体
/// </summary>
[SugarTable("T_IAS_MEETINGENTRY")]
public class TIasMeetingentry : BaseEntity
{
    /// <summary>
    /// 序号
    /// </summary>
    ...
    /// 第一次提醒时间
    /// </summary>
    [SugarColumn(ColumnName = "FFIRSTREMIND")]
    public DateTime? Ffirstremind { get; set; }

    /// <summary>
    /// 第二次提醒时间
    /// </summary>
    [SugarColumn(ColumnName = "FSECONDREMIND")]
    public DateTime? Fsecondremind { get; set; }

    /// <summary>
    /// 第三次提醒时间
    /// </summary>
    [SugarColumn(ColumnName = "FTHIRDREMIND")]
    public DateTime? Fthirdremind { get; set; }

    /// <summary>
    /// 反馈编号
    /// </summary>
    [SugarColumn(ColumnName = "FFEEDBACKNO")]
    public string Ffeedbackno { get; set; } = string.Empty;

    /// <summary>
    /// 反馈内码
    /// </summary>
    [SugarColumn(ColumnName = "FFEEDBACKID")]
    public string Ffeedbackid { get; set; } = string.Empty;

    /// <summary>
    /// 任务关闭意见
    /// </summary>
    [SugarColumn(ColumnName = "FCLOSEOPINION")]
    public string Fcloseopinion { get; set; } = string.Empty;
