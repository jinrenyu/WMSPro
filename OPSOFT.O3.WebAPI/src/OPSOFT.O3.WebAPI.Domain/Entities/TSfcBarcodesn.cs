...
/// SN条码表
/// </summary>
[SugarTable("T_SFC_BARCODESN")]
public class TSfcBarcodesn : BaseEntity
{
    /// <summary>
    /// SN序列号
    /// </summary>
    [SugarColumn(ColumnName = "FSNCODE")]
    public string Fsncode { get; set; } = string.Empty;
    ...
    /// 过程状态
    /// </summary>
    [SugarColumn(ColumnName = "FSNSTATUS")]
    public int Fsnstatus { get; set; }
    ...
    /// SN累计返工次数
    /// </summary>
    [SugarColumn(ColumnName = "FREWORKTIMES")]
    public int Freworktimes { get; set; }

    /// <summary>
    /// 返工方案内码
    /// </summary>
    [SugarColumn(ColumnName = "FREWORKID")]
    public string Freworkid { get; set; } = string.Empty;

    /// <summary>
    /// 最后一道工序是否汇报
    /// </summary>
    [SugarColumn(ColumnName = "FISLASTREPORT")]
    public bool Fislastreport { get; set; }
}
