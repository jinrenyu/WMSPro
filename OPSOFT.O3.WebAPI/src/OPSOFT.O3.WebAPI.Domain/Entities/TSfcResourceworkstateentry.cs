...
/// 资源生产状态表体
/// </summary>
[SugarTable("T_SFC_RESOURCEWORKSTATEENTRY")]
public class TSfcResourceworkstateentry : BaseEntity
{
    /// <summary>
    /// 任务单内码
    /// </summary>
    ...
    /// 前运行状态
    /// </summary>
    [SugarColumn(ColumnName = "FPRERUNSTATUS")]
    public string Fprerunstatus { get; set; } = string.Empty;

    /// <summary>
    /// 前数据状态
    /// </summary>
    [SugarColumn(ColumnName = "FPREDATASTATUS")]
    public string Fpredatastatus { get; set; } = string.Empty;
    ...
    /// 班次内码
    /// </summary>
    [SugarColumn(ColumnName = "FSHIFTID", IsNullable = true)]
