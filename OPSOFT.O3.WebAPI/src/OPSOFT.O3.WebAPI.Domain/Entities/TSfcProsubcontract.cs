...
/// 工序委外申请单
/// </summary>
[SugarTable("T_SFC_PROSUBCONTRACT")]
public class TSfcProsubcontract : BaseEntity
{
    /// <summary>
    /// 单据日期
    /// </summary>
    ...
    /// 工序委外订单内码
    /// </summary>
    [SugarColumn(ColumnName = "FPROSUBORDERID")]
    public string Fprosuborderid { get; set; } = string.Empty;
