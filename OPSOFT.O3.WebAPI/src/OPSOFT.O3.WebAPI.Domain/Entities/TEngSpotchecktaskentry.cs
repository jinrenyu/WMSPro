...
/// 点检任务表体
/// </summary>
[SugarTable("T_ENG_SPOTCHECKTASKENTRY")]
public class TEngSpotchecktaskentry : BaseEntity
{
    /// <summary>
    /// 设备内码
    /// </summary>
    ...
    /// 点检内容
    /// </summary>
    [SugarColumn(ColumnName = "FSPOTCONTENT")]
    public string Fspotcontent { get; set; } = string.Empty;
