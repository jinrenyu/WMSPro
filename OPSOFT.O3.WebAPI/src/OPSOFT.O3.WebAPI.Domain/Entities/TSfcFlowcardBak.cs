...
/// 工序流转卡-备份
/// </summary>
[SugarTable("T_SFC_FLOWCARD_BAK")]
public class TSfcFlowcardBak : BaseEntity
{
    /// <summary>
    /// 变更日期
    /// </summary>
    ...
    public string Fchangerid { get; set; } = string.Empty;
    ...
    /// 变更单编号
    /// </summary>
    [SugarColumn(ColumnName = "FCHGBILLNO")]
    public string Fchgbillno { get; set; } = string.Empty;
