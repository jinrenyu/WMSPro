...
/// 拣货任务明细-条码明细
/// </summary>
[SugarTable("T_STK_PICKTASTENTRY2")]
public class TStkPicktastentry2 : BaseEntity
{
    /// <summary>
    /// 辅助属性
    /// </summary>
    ...
    /// 拣货容器
    /// </summary>
    [SugarColumn(ColumnName = "FCONTAINERID")]
    public string Fcontainerid { get; set; } = string.Empty;

    /// <summary>
    /// 分播位
    /// </summary>
    [SugarColumn(ColumnName = "FPOINTID")]
    public string Fpointid { get; set; } = string.Empty;
