...
/// 过程检验表体-缺陷
/// </summary>
[SugarTable("T_SFC_PROCESSINPECTIONENTRY1")]
public class TSfcProcessinpectionentry1 : BaseEntity
{
    /// <summary>
    /// 缺陷类型
    /// </summary>
    ...
    /// 不良品条码
    /// </summary>
    [SugarColumn(ColumnName = "FBADBARCODE")]
    public string Fbadbarcode { get; set; } = string.Empty;
