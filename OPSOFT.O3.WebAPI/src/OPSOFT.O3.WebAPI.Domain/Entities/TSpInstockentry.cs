...
public class TSpInstockentry : BaseEntity
{
    ...
    /// 领料标识
    /// </summary>
    [SugarColumn(ColumnName = "FISPICK", IsNullable = true)]
    public bool? FISPICK { get; set; }
    ...
    /// 关联退库数量(基本单位)
    /// </summary>
    [SugarColumn(ColumnName = "FBASEJOINQTY", IsNullable = true)]
    ...
    /// 关联退库数量(库存辅单位)
    /// </summary>
    [SugarColumn(ColumnName = "FSECJOINQTY", IsNullable = true)]
    public decimal? FSECJOINQTY { get; set; }
    ...
    /// 关联退库数量
    /// </summary>
    [SugarColumn(ColumnName = "FJOINQTY", IsNullable = true)]
