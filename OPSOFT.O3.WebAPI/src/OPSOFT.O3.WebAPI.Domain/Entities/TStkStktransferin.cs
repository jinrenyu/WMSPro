...
/// 调拨单
/// </summary>
[SugarTable("T_STK_STKTRANSFERIN")]
public class TStkStktransferin : BaseEntity
{
    /// <summary>
    /// 单据类型
    /// </summary>
    ...
    public string Ftransferdirect { get; set; } = string.Empty;
    ...
    public string Ftransferbiztype { get; set; } = string.Empty;
    ...
    /// 调拨类型
    /// </summary>
    [SugarColumn(ColumnName = "FTRANSFERTYPE")]
    public string Ftransfertype { get; set; } = string.Empty;
