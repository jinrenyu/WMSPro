<template>
  <div class="mra-edit-container">
    ...
    <div class="edit-toolbar">
      ...
      <el-button v-if="isEdit && form.fStatus === 40" plain @click="handleDrillDown" v-permission="'returnreq:trace'">
...
const handleDrillDown = () => drillDialog.value?.open('PUR_MRAPP', form.fbillno, '退料申请单')
