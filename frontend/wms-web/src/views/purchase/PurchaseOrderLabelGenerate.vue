<template>
  <div class="po-label-generate" v-loading="loading">
    <div class="edit-toolbar">
      <el-button type="primary" @click="handleGenerate" :loading="generating" v-permission="'labelpurchaseorder:generate'">
    ...
    <el-form label-width="92px" class="head-form" size="small">
      <!-- 来源采购订单信息（只读） -->
      <el-row :gutter="16">
        <el-col :span="8"><el-form-item label="单据编号"><el-input :model-value="head.fbillno" disabled /></el-form-item></el-col>
        <el-col :span="8"><el-form-item label="订单日期"><el-input :model-value="fmtDate(head.fdate)" disabled /></el-form-item></el-col>
        <el-col :span="8"><el-form-item label="采购组织"><el-input :model-value="head.fcompanyName" disabled /></el-form-item></el-col>
      </el-row>
      <el-row :gutter="16">
        <el-col :span="8"><el-form-item label="业务类型"><el-input :model-value="head.fbusinesstype" disabled /></el-form-item></el-col>
      ...
      <el-row :gutter="16">
        <el-col :span="8"><el-form-item label="采购数量"><el-input :model-value="fmtNum(head.fqty)" disabled /></el-form-item></el-col>
        ...
        <el-col :span="8">
          <el-form-item label="启用批次">
            ...
            <span class="inline-label">启用报检</span>
    ...
    >
      ...
      <el-table-column prop="fcompanyName" label="采购组织" width="110" />
      ...
      <el-table-column prop="fpurbillno" label="收料单编号" width="160" />
    </el-table>
  </div>
</template>
...
const kfUnitLabel = (v?: number) => (v === 0 ? '日' : v === 1 ? '月' : v === 2 ? '年' : '日')
...
async function loadHead() {
  ...
  try {
    ...
    const h: PurchaseOrderLabelHead = res.data
    if (!h) { ElMessage.error('采购订单明细不存在'); return }
    head.value = h
    form.flot = h.flot || ''
